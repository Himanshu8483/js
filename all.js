...
//     console.log("outer message = " + a)     // outer message = 5
// }
// start();        // Function Call for print in Console OR Prompt, Alert & for Confirm
...
function myFunction(msg, n){       // parameter -> input
    console.log(msg+n);     // I love JS 100
}
...
// // ARROW FUNCTION
// //  Eg : const go=()=>{   }   // arrow function is the short way to write a function for single line code
//     let arrow=(a,b)=>{
...
// // MAP
    // let arr=[4,7,2,5,9,1] 
    // let ans = arr.map((num)=> num*2)        // arrow function
...
// // forEach FUNCTION
//     let ans1 = arr.forEach((num)=>{          // string return & original array not change
//         let num1=num*2
